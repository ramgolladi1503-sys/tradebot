...
_CANONICAL_ADVISORY_FIELDS = {
    ...
    "execution_score",
    "priority_score",
    "priority_weight_signal",
    "priority_weight_execution",
    "setup_score",
    "trigger_score",
    "entry_quality_score",
    ...
    "adaptive_threshold_impact_score",
    "adaptive_threshold_applied",
    "adaptive_threshold_key",
    "risk_budget_ok",
    "risk_budget_reason",
    "position_size_estimate",
    "portfolio_heat_score",
    "correlation_penalty",
    "exposure_blocker",
    ...
    "starvation_flag",
    "starvation_reason",
    "warning_engine_too_timid",
    "warning_filtering_without_edge_improvement",
    "warning_family_starvation",
    "warning_threshold_cluster",
    ...
    "aggressiveness_adjustment_applied",
    "market_mode",
    "data_state",
    "data_confidence",
    "direction_family",
    ...
    "family_blocker",
    "family_strength",
    "family_allowed_in_context",
    "family_gate_reason",
    "family_gate_override_applied",
    "fallback_candidate",
    "fresh_quote_ok",
    "liquidity_ok",
    "spread_ok",
