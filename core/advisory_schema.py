...
def validate_advisory_row(payload: dict[str, Any], *, allow_legacy: bool = False) -> dict[str, Any]:
    ...
    for field_name, value in (
        ...
        ("truth_quality", _normalize_text(out.get("truth_quality"))),
        ("truth_quality_source", _normalize_text(out.get("truth_quality_source"))),
        ("truth_allows_execution", _normalize_bool(out.get("truth_allows_execution"))),
        ("truth_block_reason", _normalize_text(out.get("truth_block_reason"))),
        ("quote_truth_state", _normalize_text(out.get("quote_truth_state"))),
