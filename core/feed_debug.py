...
def get_feed_debug(now_epoch: Optional[float] = None) -> dict[str, Any]:
    ...
    return {
        ...
        "last_recovery_generation_id": snapshot_payload.get("last_recovery_generation_id") if isinstance(snapshot_payload, dict) else None,
        "subscription_generation_id": snapshot_payload.get("subscription_generation_id") if isinstance(snapshot_payload, dict) else None,
