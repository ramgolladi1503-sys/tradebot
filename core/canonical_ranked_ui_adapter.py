...
def adapt_candidate_rank_record_to_ui(record: dict) -> dict:
    ...
    row = {
        ...
        "rank_score": record.get("rank_score") if record.get("rank_score") is not None else record.get("final_score"),
    ...
    return annotate_top_opportunity_authority(
        ...
        phase2_score=record.get("phase2_score") if "phase2_score" in record else None,
        raw_strategy_score=record.get("raw_strategy_score") if "raw_strategy_score" in record else record.get("raw_score") if "raw_score" in record else None,
