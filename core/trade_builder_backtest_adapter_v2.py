...
from core.historical_option_chain_realish import RealishHistoricalOptionChainBuilder


class TradeBuilderBacktestAdapterV2:
    """Improved adapter using semi-realistic option chain."""

    def __init__(self):
        self.builder = TradeBuilder()
        self.chain_builder = RealishHistoricalOptionChainBuilder()
