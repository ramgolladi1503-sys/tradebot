...
def build_candidate_decision_record(
    ...
    *,
    ...
    return {
        ...
        "setup_regime_alignment_score": _safe_float(_candidate_get(candidate, "setup_regime_alignment_score")),
        "setup_structure_score": _safe_float(_candidate_get(candidate, "setup_structure_score")),
        "setup_thesis_score": _safe_float(_candidate_get(candidate, "setup_thesis_score")),
        "trigger_score": _safe_float(_candidate_get(candidate, "trigger_score")),
        "trigger_base_score": _safe_float(_candidate_get(candidate, "trigger_base_score")),
        "entry_quality_score": _safe_float(_candidate_get(candidate, "entry_quality_score")),
        "entry_invalidation_score": _safe_float(_candidate_get(candidate, "entry_invalidation_score")),
        "entry_overextension_score": _safe_float(_candidate_get(candidate, "entry_overextension_score")),
        "entry_timing_quality_score": _safe_float(_candidate_get(candidate, "entry_timing_quality_score")),
