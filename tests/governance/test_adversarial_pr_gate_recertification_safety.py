...
def test_manifest_requires_exact_sha_scope_and_authorized_fields(monkeypatch):
    candidate_sha = "a" * 40
...
def test_manifest_with_exact_candidate_sha_and_scope_is_accepted(monkeypatch):
    candidate_sha = "a" * 40
    monkeypatch.setattr(gate, "_git", lambda *args: candidate_sha)
