...
def test_no_direct_broker_place_order_bypass() -> None:
    allowlist = {"core/kite_client.py", "tools/legacy/flatten_positions.py"}
    chokepoint_required = {"tools/legacy/flatten_positions.py"}
    offenders: list[str] = []
