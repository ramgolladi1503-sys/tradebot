...
def _evidence(contract):
    ...
    token_lifecycle = {
        str(token): {
            ...
            "mode_command_dispatched_epoch": 12.0,
            "mode_command_local_send_succeeded_epoch": 12.0,
            "mode_delivery_observed_epoch": 14.0,
            "final_current_generation_local_mode": "full",
            "final_current_generation_local_mode_is_full": True,
            "latest_subscribe_sequence_number": 1,
            "latest_mode_command_sequence_number": 2,
            "post_mode_callback_count": 1,
            "post_mode_quote_count": 0,
            "post_mode_full_count": 1,
            "mode_request_succeeded_epoch": 12.0,
            "first_live_tick_epoch": 13.0,
            "first_post_request_tick_epoch": 13.0,
    ...
    return {
        ...
        "mode_command_dispatched_symbols": required,
        "mode_command_local_send_succeeded_symbols": required,
        "mode_delivery_observed_symbols": required,
        "final_current_generation_full_mode_symbols": required,
...
def test_history_seeded_and_fallback_bars_are_rejected(monkeypatch, tmp_path):
    ...
    blocked_provenance = {
        ...
        "first_post_request_tick_epoch": 61.0,
