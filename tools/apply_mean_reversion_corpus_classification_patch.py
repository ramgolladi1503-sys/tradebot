...
def main() -> None:
    integrity_path = Path("core/research_backtest_integrity.py")
...
''',
    ...
    generator_path = Path("scripts/generate_mean_reversion_trade_ledger.py")
...
''',
    ...
    Path("tests/test_research_candle_contract.py").write_text(
        '''from __future__ import annotations
...
''',
    ...
    review_path = Path(
        "docs/agent_reviews/mean_reversion_corpus_file_classification.md"
    )
...
''',
    ...
    Path(".github/workflows/apply_mean_reversion_corpus_classification_patch.yml").unlink()
    Path("tools/apply_mean_reversion_corpus_classification_patch.py").unlink()
