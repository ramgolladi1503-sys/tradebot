...
def main() -> int:
    ...
    chunks = ingest_evidence_paths([Path(value) for value in args.paths], document_type_by_suffix={".json": "STRUCTURED_EVIDENCE", ".md": "MARKDOWN_EVIDENCE", ".txt": "TEXT_EVIDENCE"}, max_characters_per_chunk=args.max_characters_per_chunk)
