#!/usr/bin/env python3
"""Run the independent common-factor option-underreaction campaign."""
...
from research.common_factor_option_underreaction_v1.campaign import run_campaign
...
def main() -> int:
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("runtime/research/common_factor_option_underreaction_v1"),
    )
