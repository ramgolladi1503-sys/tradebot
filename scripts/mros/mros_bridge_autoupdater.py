...
BRANCH='research/mros-agent-bridge-v1';SERVICES=('com.aixion.mros-agent-worker','com.aixion.mros-autonomous-supervisor');DEPLOY_EPOCH='r114-worker-isolation-force-v1-20260808'
