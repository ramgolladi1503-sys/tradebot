...
def main()->int:
 ...
 try:
  ...
  try:
   tests=[str(test_root/'tests/mros/test_mros_agent_bridge.py'),str(test_root/'tests/mros/test_mros_autonomous_supervisor.py'),str(test_root/'tests/mros/test_mros_state_transition_engine.py')]
