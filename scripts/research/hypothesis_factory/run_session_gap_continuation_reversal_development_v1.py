...
RUNNER_ID = "SESSION_GAP_DEVELOPMENT_OUTCOME_V1"
SEARCH_FAMILY_ID = "SESSION_GAP_CONTINUATION_REVERSAL_FAMILY_V1"
...
def main():
    ...
    parser.add_argument("--candidates-input", default="research/evidence/behavior_discovery_engine_v2/NIFTY_session_gap_continuation_reversal_candidates_v1.jsonl")
    parser.add_argument("--development-output", default="research/evidence/behavior_discovery_engine_v2/NIFTY_session_gap_continuation_reversal_development_v1.json")
    ...
    if len(supported) > 2:
        ...
        status = "NO_DEVELOPMENT_SUPPORTED_SESSION_GAP_CONTINUATION_REVERSAL_CANDIDATE"
