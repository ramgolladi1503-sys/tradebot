...
RUNNER_ID = "PRE_CLOSE_IMBALANCE_DEVELOPMENT_OUTCOME_V1"
...
def main():
    ...
    parser.add_argument("--candidates-input", default="research/evidence/behavior_discovery_engine_v2/NIFTY_pre_close_imbalance_proxy_candidates_v1.jsonl")
    parser.add_argument("--development-output", default="research/evidence/behavior_discovery_engine_v2/NIFTY_pre_close_imbalance_proxy_development_v1.json")
    ...
    if len(supported) > 2:
        ...
        status = "NO_DEVELOPMENT_SUPPORTED_PRE_CLOSE_IMBALANCE_PROXY_CANDIDATE"
