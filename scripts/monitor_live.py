...
print(
    f"Feed Health: WS Connected: {ws_connected} | Fresh: {feed_fresh} | LTP Age: {ltp_age}s"
)
...
print(
    f"Engine Status: Feed OK: {feed_ok} | Stage: {cycle_stage} | Blocker: {primary_blocker}"
)
...
print(
    f"Candidates: Status: {status} | Suggestions: {suggestion_count} | Reason: {reason}"
)
