...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run walk-forward on engineered historical candles.")
    ...
    print(f"windows={summary['config']['window_count']} avg_return={summary['aggregate']['avg_return']:.6f}")
    return 0
