...
def main() -> int:
    ...
    parser.add_argument("--runtime-health", default=None, help="Optional runtime_health_latest.json path.")
    parser.add_argument("--feed-runtime", default=None, help="Optional feed_runtime_latest.json path.")
    parser.add_argument("--engine-status", default=None, help="Optional engine_cycle_status.json path.")
    parser.add_argument("--family-outcomes", default=None, help="Optional family_outcomes.jsonl path.")
    parser.add_argument("--paper-log", default=None, help="Optional paper_market_*.log path.")
