...
def convert_jsonl_to_parquet(input_file: Path, delete_original: bool = False):
    ...
    logger.info(f"Reading JSONL from {input_file} (this may take a moment for large files)...")
...
def main():
    ...
    parser.add_argument("--delete", action="store_true", help="Delete the original .jsonl file after successful conversion")
