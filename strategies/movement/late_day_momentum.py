...
def _build_candidate(
    ...
    return make_candidate(
        ...
        side=side,
        entry_trigger="late_day_directional_continuation",
        invalid_if="momentum_fades_or_price_returns_to_vwap",
        rank_reason="late-day directional structure continues with momentum",
        evidence=evidence,
        warnings=warnings,
        confluence_tags=("late_day", "momentum"),
