...
| Path | Verdict | Reason |
|---|---|---|
| `docs/agent_reviews/pr_605_htf_opening_drive_paper_telemetry.md` | `BLOCK` | `required_evidence_field_missing` |
| `docs/agent_reviews/pr_605_htf_opening_drive_paper_telemetry.md` | `BLOCK` | `required_evidence_field_missing` |
| `docs/agent_reviews/pr_605_htf_opening_drive_paper_telemetry.md` | `BLOCK` | `required_evidence_field_missing` |
| `docs/agent_reviews/pr_605_htf_opening_drive_paper_telemetry.md` | `BLOCK` | `required_evidence_field_missing` |
| `docs/agent_reviews/pr_605_htf_opening_drive_paper_telemetry.md` | `BLOCK` | `required_evidence_field_missing` |
...
| `docs/agent_reviews/pr_605_htf_opening_drive_paper_telemetry.md` | `BLOCK` | `required_evidence_field_missing` |
| `docs/agent_reviews/pr_605_htf_opening_drive_paper_telemetry.md` | `BLOCK` | `required_evidence_field_missing` |
| `docs/agent_reviews/pr_605_htf_opening_drive_paper_telemetry.md` | `BLOCK` | `weak_evidence_pattern_found` |
