...
def market_tick_to_event(
    ...
    *,
    ...
    event_time = _parse_time(
        tick.get("exchange_timestamp") or tick.get("event_time") or tick.get("timestamp"),
        name="event_time",
    )
    available_time = _parse_time(tick.get("available_time") or event_time, name="available_time")
    source_time = _parse_time(tick.get("source_time") or event_time, name="source_time")
    ...
    payload = {
        ...
        "open_interest": _finite_or_none(tick.get("open_interest") or tick.get("oi"), name="open_interest"),
        "implied_volatility": _finite_or_none(tick.get("implied_volatility") or tick.get("iv"), name="implied_volatility"),
    ...
    return CanonicalEvent(
        event_id=_event_id(
            ...
            payload={**tick, "source_sequence": tick.get("source_sequence")},
        ),
        event_type="MARKET_TICK",
            ...
            market_tick_to_event(
                {
                    **row,
                    ...
                    or snapshot.get("exchange_timestamp")
                    or snapshot.get("event_time"),
                    "available_time": row.get("available_time")
                    or snapshot.get("available_time")
                    or snapshot.get("event_time"),
                    "source_time": row.get("source_time")
                    or snapshot.get("source_time")
                    or snapshot.get("event_time"),
                    "metadata": {
