...
CANDIDATE_SCORING_LIQUIDITY_OI_MISSING_SCORE = float(
    os.getenv("CANDIDATE_SCORING_LIQUIDITY_OI_MISSING_SCORE", "0.25")
)
...
CANDIDATE_SCORING_LIQUIDITY_SPREAD_WEIGHT = float(
    os.getenv("CANDIDATE_SCORING_LIQUIDITY_SPREAD_WEIGHT", "0.20")
)
...
LATENCY_GUARD_LIVE_SKIP_BACKGROUND_MAINTENANCE = (
    os.getenv("LATENCY_GUARD_LIVE_SKIP_BACKGROUND_MAINTENANCE", "true").lower() == "true"
)
...
FEED_FRESHNESS_PREFER_RUNTIME_OPTION_AGES_ENABLE = (
    os.getenv("FEED_FRESHNESS_PREFER_RUNTIME_OPTION_AGES_ENABLE", "true").lower() == "true"
)
RUNTIME_SNAPSHOT_ADVISORY_FALLBACK_CANDIDATE_DECISIONS_ENABLE = (
    os.getenv("RUNTIME_SNAPSHOT_ADVISORY_FALLBACK_CANDIDATE_DECISIONS_ENABLE", "true").lower() == "true"
)
RUNTIME_SNAPSHOT_ADVISORY_FALLBACK_CANDIDATE_DECISIONS_LIMIT = int(
    os.getenv("RUNTIME_SNAPSHOT_ADVISORY_FALLBACK_CANDIDATE_DECISIONS_LIMIT", "200")
)
FEED_FRESHNESS_MAX_STALE_TOKEN_RATIO = float(
    os.getenv("FEED_FRESHNESS_MAX_STALE_TOKEN_RATIO", "0.30")
)
...
BREAKER_STALE_FEED_MIN_OPTION_ROWS = int(os.getenv("BREAKER_STALE_FEED_MIN_OPTION_ROWS", "8"))
...
FEED_PRUNE_STALE_OPTION_SUBSCRIPTIONS_ENABLE = (
    os.getenv("FEED_PRUNE_STALE_OPTION_SUBSCRIPTIONS_ENABLE", "true").lower() == "true"
)
FEED_PRUNE_STALE_OPTION_SUBSCRIPTIONS_MAX_AGE_SEC = float(
    os.getenv("FEED_PRUNE_STALE_OPTION_SUBSCRIPTIONS_MAX_AGE_SEC", "2.5")
)
FEED_PRUNE_STALE_OPTION_SUBSCRIPTIONS_GRACE_SEC = float(
    os.getenv("FEED_PRUNE_STALE_OPTION_SUBSCRIPTIONS_GRACE_SEC", "60.0")
)
FEED_PRUNE_STALE_OPTION_SUBSCRIPTIONS_REQUIRE_SESSION_TICK = (
    os.getenv("FEED_PRUNE_STALE_OPTION_SUBSCRIPTIONS_REQUIRE_SESSION_TICK", "true").lower() == "true"
)
SETUP_FALLBACK_STRIKE_OFFSET_SCALE = float(os.getenv("SETUP_FALLBACK_STRIKE_OFFSET_SCALE", "20.0"))
CANDIDATE_DECISION_SETUP_SCORE_DERIVE_FROM_PROXY_ENABLE = (
    os.getenv("CANDIDATE_DECISION_SETUP_SCORE_DERIVE_FROM_PROXY_ENABLE", "true").lower() == "true"
)
FEED_STALE_OPTION_SUBSCRIPTION_REFRESH_SEC = float(
    os.getenv("FEED_STALE_OPTION_SUBSCRIPTION_REFRESH_SEC", "20.0")
)
FEED_STALE_OPTION_SUBSCRIPTION_MIN_FRESH_RATIO = float(
    os.getenv("FEED_STALE_OPTION_SUBSCRIPTION_MIN_FRESH_RATIO", "0.9")
)
FEED_STALE_OPTION_SUBSCRIPTION_URGENT_MAX_AGE_SEC = float(
    os.getenv("FEED_STALE_OPTION_SUBSCRIPTION_URGENT_MAX_AGE_SEC", "1.5")
)
FEED_STALE_OPTION_SUBSCRIPTION_DRIFT_REFRESH_SEC = float(
    os.getenv("FEED_STALE_OPTION_SUBSCRIPTION_DRIFT_REFRESH_SEC", "2.0")
)
FEED_STALE_OPTION_SUBSCRIPTION_SYMBOL_SCOPE_ENABLE = (
    os.getenv("FEED_STALE_OPTION_SUBSCRIPTION_SYMBOL_SCOPE_ENABLE", "true").lower() == "true"
)
...
FEED_HEALTH_INDEX_OK_AGE_SEC = float(os.getenv("FEED_HEALTH_INDEX_OK_AGE_SEC", "5.0"))
FEED_HEALTH_OPTION_OK_AGE_SEC = float(os.getenv("FEED_HEALTH_OPTION_OK_AGE_SEC", "8.0"))
FEED_HEALTH_INDEX_DOWN_NO_MSG_SEC = float(os.getenv("FEED_HEALTH_INDEX_DOWN_NO_MSG_SEC", "10.0"))
FEED_HEALTH_OPTION_DOWN_NO_MSG_SEC = float(os.getenv("FEED_HEALTH_OPTION_DOWN_NO_MSG_SEC", "15.0"))
...
FEED_AUTO_REPAIR_LTP_STALE_TRIGGER_STRIKES = max(
    1, int(os.getenv("FEED_AUTO_REPAIR_LTP_STALE_TRIGGER_STRIKES", "4"))
)
