...
FEED_STALE_OPTION_SUBSCRIPTION_MIN_FRESH_RATIO = float(
    os.getenv("FEED_STALE_OPTION_SUBSCRIPTION_MIN_FRESH_RATIO", "0.8")
)
FEED_STALE_OPTION_SUBSCRIPTION_URGENT_MAX_AGE_SEC = float(
    os.getenv("FEED_STALE_OPTION_SUBSCRIPTION_URGENT_MAX_AGE_SEC", "2.0")
)
FEED_STALE_OPTION_SUBSCRIPTION_DRIFT_REFRESH_SEC = float(
    os.getenv("FEED_STALE_OPTION_SUBSCRIPTION_DRIFT_REFRESH_SEC", "5.0")
)
