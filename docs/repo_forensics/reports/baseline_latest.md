...
| Class | Count |
|---|---:|
| EVIDENCE_CONTRACT | 383 |
| FAKE_CONFIDENCE | 111 |
| INTEGRATION_WIRING | 7 |
| RUNTIME_COMMAND | 20 |
| SAFETY_REGRESSION | 224 |
| SHAPE_ONLY | 7 |
| UNIT_BEHAVIOR | 152 |
| UNKNOWN | 8 |
...
| truncated | INFO | n/a | remaining=142 |  |
...
| truncated | INFO | n/a | remaining=72 | n/a |
...
- HIGH: safety findings truncated count=142
...
- MEDIUM: evidence findings truncated count=72
