...
| `main.py` | PRODUCTION_REFERENCED | 195 | 19 | production_reference_found |
...
| Module | Status | Production Callers | Test Callers | Evidence |
|---|---|---:|---:|---|
| `core/orchestrator.py` | PRODUCTION_REFERENCED | 3 | 40 | production_reference_found |
| `core/orchestrator_parts/cycle.py` | PRODUCTION_REFERENCED | 2 | 1 | production_reference_found |
| `core/orchestrator_parts/data.py` | PRODUCTION_REFERENCED | 89 | 21 | production_reference_found |
| `core/orchestrator_parts/decisions.py` | PRODUCTION_REFERENCED | 26 | 6 | production_reference_found |
...
| Module | Status | Production Callers | Test Callers | Evidence |
|---|---|---:|---:|---|
| `core/market_data.py` | PRODUCTION_REFERENCED | 61 | 44 | production_reference_found |
| `core/kite_depth_ws.py` | PRODUCTION_REFERENCED | 13 | 15 | production_reference_found |
...
| Module | Status | Production Callers | Test Callers | Evidence |
|---|---|---:|---:|---|
| `strategies/trade_builder.py` | PRODUCTION_REFERENCED | 9 | 46 | production_reference_found |
| `core/engine_phase2_adapter.py` | PRODUCTION_REFERENCED | 1 | 7 | production_reference_found |
...
| `core/decision_dag.py` | PRODUCTION_REFERENCED | 2 | 6 | production_reference_found |
...
| Module | Status | Production Callers | Test Callers | Evidence |
|---|---|---:|---:|---|
| `core/execution_engine.py` | PRODUCTION_REFERENCED | 8 | 19 | production_reference_found |
| `core/execution_router.py` | PRODUCTION_REFERENCED | 2 | 8 | production_reference_found |
...
| `core/kite_client.py` | PRODUCTION_REFERENCED | 44 | 27 | production_reference_found |

### evidence_and_dashboard

| Module | Status | Production Callers | Test Callers | Evidence |
|---|---|---:|---:|---|
| `core/events.py` | PRODUCTION_REFERENCED | 105 | 49 | production_reference_found |
...
| Class | Count |
|---|---:|
| EVIDENCE_CONTRACT | 353 |
| FAKE_CONFIDENCE | 115 |
| INTEGRATION_WIRING | 6 |
| RUNTIME_COMMAND | 20 |
| SAFETY_REGRESSION | 223 |
| SHAPE_ONLY | 7 |
| UNIT_BEHAVIOR | 130 |
| UNKNOWN | 9 |
...
| truncated | INFO | n/a | remaining=99 | n/a |
...
| `dashboard/streamlit_app_runtime.py` | HIGH | readonly_execution_import | execution_import_in_readonly_path:core.kite_client.kite_client | 5328 |
| `dashboard/streamlit_app_runtime.py` | HIGH | readonly_execution_import | execution_import_in_readonly_path:core.kite_client | 5342 |
| truncated | INFO | n/a | remaining=72 |  |
...
| truncated | INFO | n/a | remaining=102 | n/a |
...
- Unknown test files: 9
- Safety critical findings: 21
- Safety high findings: 81
- Safety unknown findings: 0
- Evidence high findings: 116
- Evidence medium findings: 16
...
- MEDIUM: fake-confidence test signal truncated count=95
...
- HIGH: safety boundary `dashboard/streamlit_app_runtime.py:5328` boundary=readonly_execution_import evidence=execution_import_in_readonly_path:core.kite_client.kite_client
- HIGH: safety boundary `dashboard/streamlit_app_runtime.py:5342` boundary=readonly_execution_import evidence=execution_import_in_readonly_path:core.kite_client
- HIGH: safety findings truncated count=72
...
- MEDIUM: evidence findings truncated count=102
