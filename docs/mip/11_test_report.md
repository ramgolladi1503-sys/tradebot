...
3. **`test_intelligence_adapter_cannot_mutate_executable_state`**: Verifies that calling the `ContextAdapter` to append relevance models does not modify `candidate["execution_ok"]`, `candidate["candidate_stat-us"]`, or blockers.
