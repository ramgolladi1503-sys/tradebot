...
| `main.py` | PRODUCTION_REFERENCED | 191 | 19 | production_reference_found |
...
| Module | Status | Production Callers | Test Callers | Evidence |
|---|---|---:|---:|---|
| `core/orchestrator.py` | PRODUCTION_REFERENCED | 3 | 39 | production_reference_found |
...
| `core/kite_depth_ws.py` | PRODUCTION_REFERENCED | 10 | 15 | production_reference_found |
...
| Module | Status | Production Callers | Test Callers | Evidence |
|---|---|---:|---:|---|
| `strategies/trade_builder.py` | PRODUCTION_REFERENCED | 9 | 45 | production_reference_found |
| `core/engine_phase2_adapter.py` | PRODUCTION_REFERENCED | 1 | 6 | production_reference_found |
...
| `core/kite_client.py` | PRODUCTION_REFERENCED | 43 | 27 | production_reference_found |

### evidence_and_dashboard

| Module | Status | Production Callers | Test Callers | Evidence |
|---|---|---:|---:|---|
| `core/events.py` | PRODUCTION_REFERENCED | 105 | 48 | production_reference_found |
...
| Class | Count |
|---|---:|
| EVIDENCE_CONTRACT | 344 |
| FAKE_CONFIDENCE | 123 |
| INTEGRATION_WIRING | 6 |
| RUNTIME_COMMAND | 19 |
| SAFETY_REGRESSION | 222 |
| SHAPE_ONLY | 7 |
| UNIT_BEHAVIOR | 128 |
| UNKNOWN | 8 |
...
| truncated | INFO | n/a | remaining=106 | n/a |
...
| truncated | INFO | n/a | remaining=27 |  |
...
| truncated | INFO | n/a | remaining=86 | n/a |
...
- Fake-confidence tests: 123
- Unknown test files: 8
- Safety critical findings: 21
- Safety high findings: 36
- Safety unknown findings: 0
- Evidence high findings: 102
...
- MEDIUM: fake-confidence test signal truncated count=103
...
- HIGH: safety findings truncated count=27
...
- MEDIUM: evidence findings truncated count=86
