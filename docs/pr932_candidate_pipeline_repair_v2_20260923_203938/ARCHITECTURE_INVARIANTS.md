...
3. **No Phantom Execution**: No candidate is marked  unless  and .
4. **Conservation of Observations**: Every incoming symbol evaluation maps 1-to-1 to a  record.
5. **Truth Law Adherence**: Missing prices remain . No arbitrary fallbacks (e.g. 100.0) are allowed.
