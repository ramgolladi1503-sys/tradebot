...
def build_coverage_report(records: list[SourceRecord]) -> dict[str, Any]:
    return {
        "resolved": sum(1 for record in records if record.resolution_status == "SIGNAL_LEDGER_CERTIFIED"),
        "blocked": sum(1 for record in records if record.resolution_status != "SIGNAL_LEDGER_CERTIFIED"),
