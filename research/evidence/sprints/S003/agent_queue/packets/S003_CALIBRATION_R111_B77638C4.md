# S003 autonomous exact-head Board calibration R111
...
2. `python3 --version`
3. `mkdir -p .mros_tmp && TMPDIR="$PWD/.mros_tmp" python3 scripts/mros/calibrate_review_audit_board_v2.py --candidate-head b77638c4ae3d3d929dbe3798479b54f4e19d2c60`
