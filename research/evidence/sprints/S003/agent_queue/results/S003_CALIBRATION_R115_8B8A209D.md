CANDIDATE_HEAD: `8b8a209d4b9e06a8e6ab9c6f0d8cf5ff005d2fd3`
...
```bash
/opt/anaconda3/bin/python3 scripts/mros/calibrate_review_audit_board_v2.py --candidate-head 8b8a209d4b9e06a8e6ab9c6f0d8cf5ff005d2fd3
```
