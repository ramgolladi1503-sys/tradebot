CANDIDATE_HEAD: `46c280e562daf81fd53d355c7ceaa3b96f6a9744`
...
```bash
/opt/anaconda3/bin/python3 scripts/mros/calibrate_review_audit_board_v2.py --candidate-head 46c280e562daf81fd53d355c7ceaa3b96f6a9744
```
...
FAIL | CAL-032 | expected=ACCEPT observed=REJECT
...
METRICS | {"declared_cases": 41, "executed_cases": 41, "extra_cases": [], "false_acceptance_rate": 0.0, "false_rejection_rate": 0.2, "known_bad_detection_rate": 1.0, "known_good_acceptance_rate": 0.8, "missing_cases": []}
SUMMARY | cases=41 pass=40 fail=1 denominator_conserved=true
