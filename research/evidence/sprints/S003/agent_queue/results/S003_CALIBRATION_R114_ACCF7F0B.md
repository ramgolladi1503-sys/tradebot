CANDIDATE_HEAD: `accf7f0b4f93a8c84714d8b378b8a2affc4185d7`
...
```bash
/opt/anaconda3/bin/python3 scripts/mros/calibrate_review_audit_board_v2.py --candidate-head accf7f0b4f93a8c84714d8b378b8a2affc4185d7
```
