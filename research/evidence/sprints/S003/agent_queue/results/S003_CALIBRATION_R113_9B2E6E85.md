CANDIDATE_HEAD: `9b2e6e853444dae0c75a9a57fce910b3389cc6f1`
...
```bash
/opt/anaconda3/bin/python3 scripts/mros/calibrate_review_audit_board_v2.py --candidate-head 9b2e6e853444dae0c75a9a57fce910b3389cc6f1
```
