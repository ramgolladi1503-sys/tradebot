CANDIDATE_HEAD: `bfae7a6cdea9f4af9a39bcbf548b4c944fdeeda5`
...
```bash
/opt/anaconda3/bin/python3 scripts/mros/calibrate_review_audit_board_v2.py --candidate-head bfae7a6cdea9f4af9a39bcbf548b4c944fdeeda5
```
