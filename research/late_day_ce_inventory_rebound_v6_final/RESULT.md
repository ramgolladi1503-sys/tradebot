...
Principal verdict: `NO_STRUCTURAL_EDGE_AFTER_INDEPENDENT_ECONOMIC_AND_SIGNAL_AUDIT`
...
Signal oracle: `FAIL_INDEPENDENT_SIGNAL_MEMBERSHIP_ORACLE` with `52` exact identities.
